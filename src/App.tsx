...
import SharedLinkRedirect from "./components/redirects/SharedLinkRedirect";
          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              <Routes>
                ...
                {/* Legacy redirect for old approval emails with /shared/:id format */}
                <Route path="/shared/:shareId/edit" element={<SharedLinkRedirect />} />
                <Route path="/shared/:shareId" element={<SharedLinkRedirect />} />
